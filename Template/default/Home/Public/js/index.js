...
function recordId(t, o) { return setCookie("cid", 0), setCookie("tid", 0), setCookie("search_word", 0), "index" != t && "/" != t && setCookie(t, o), !0 } $(function() { if ("block" == $(".b-nav-mobile").css("display")) { var t = getWidthLeft($(".b-nav-active"), !1);
