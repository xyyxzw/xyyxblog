...
<div id="welcome">
    <div class="block">
        ...
        <ul class="content">
            <li>文章总数：<?php echo ($data['all_article']); ?></li>
            <li>已删文章数：<?php echo ($data['delete_article']); ?></li>
            <li>不显示的文章数：<?php echo ($data['hide_article']); ?></li>
        </ul>
    </div>
    <div class="block">
        <h3 class="title">随言碎语统计</h3>
        <ul class="content">
            <li>随言总数：<?php echo ($data['all_chat']); ?></li>
            <li>已删随言数：<?php echo ($data['delete_chat']); ?></li>
            <li>不显示的随言数：<?php echo ($data['hide_chat']); ?></li>
        </ul>
    </div>
    <div class="block">
        <h3 class="title">评论统计</h3>
        <ul class="content">
            <li>评论总数：<?php echo ($data['all_comment']); ?></li>
        </ul>
    </div>
    <div class="block">
        ...
        <table>
            <tr>
                <th>P H P 版 本：</th>
                <td><?php echo PHP_VERSION;?></td><!-- php预定义常量 -->
            </tr>
            <tr>
                <th width="100px">服务器 信息：</th>
                <td><?php echo PHP_OS;?></td><!-- php预定义常量 -->
